...
### 1. Split `clusters/pax/AGENTS.md`

Current issue: `clusters/pax/AGENTS.md` contains cluster overview, Helm conventions, networking, secrets, backups, Postgres library docs, and app conventions in one large file.
...
This repo manages single-node k3s cluster `pax`.

Start here:
- clusters/pax/AGENTS.md for quick cluster context
- clusters/pax/apps.yaml for app inventory
- clusters/pax/kubolt.yaml for deploy/backup manifest
- clusters/pax/docs/chart-conventions.md for Helm rules

Always validate with:
- kubolt validate from clusters/pax
```
...
- A new agent can understand the repo by reading root `AGENTS.md`, `clusters/pax/AGENTS.md`, and `apps.yaml`.
